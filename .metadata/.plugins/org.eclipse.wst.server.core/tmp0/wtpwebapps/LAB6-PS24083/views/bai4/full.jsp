...
<div class="container" style="margin: 10px auto;">
	<c:url var="app" value="/bai4"></c:url>
	<h2>Tổng Hợp</h2>
	<hr>
	<form action="${app }/procedure" method="post"
		style="width: 60%; margin: 10px auto;">
		<div style="display: flex; justify-content: space-evenly;">
			<select onchange="this.form.submit()" name="year"
				class="btn btn-light" style="width: 50%; margin: 0 auto;">
				<c:forEach var="item" items="${listYear }">
							<option ${item == hi ? 'selected' : ' '} value="${item }">${item }</option>
				</c:forEach>
