...
<div class="onhead">
			...
			<div class="container d-flex flex-wrap"
				...
				<a href="/ASM-PS24083/views/jsp/index.jsp"
					...
					<svg class="bi me-2" width="40" height="32">
                        ...
                        </svg> <span class=" titlewep">Bai 2 &#169;</span>
				</a>
				<div
					...
					<div class="modal-content" style="border-radius: 10px;">
						...
						<div class="modal-body">
							<form>
								...
								<div class="form-group valid">
									<label for="exampleInputPassword1" class="badge bg-success" s>Mật
	...
	<div class="rows bg-light">
		<nav class="navbar navbar-expand-lg navbar-light bg-light"
			...
			<a class="navbar-brand" href="${app}/video"><span><i
					class='bx bxs-home'></i></span>Bai 1</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto navs">
					...
					<li class="nav-item"><a class="nav-link"
						href="${app}/findtitle" style="color: green; cursor: pointer;"
						class='bx bxs-heart'><i class='bx bxs-book-content'></i>Bai 2</a></li>
					<li class="nav-item"><a class="nav-link" href="${app}/user"
						style="color: green; cursor: pointer;" class='bx bxs-heart'><i
							class='bx bxs-book-content'></i>Bai 3</a></li>
					<li class="nav-item"><a class="nav-link" href="${app}/check"
						style="color: green; cursor: pointer;" class='bx bxs-heart'><i
							class='bx bxs-book-content'></i>Bai 4</a></li>
					<li class="nav-item"><a class="nav-link" href="${app}/full"
						style="color: green; cursor: pointer;" class='bx bxs-heart'><i
							class='bx bxs-book-content'></i>Bai 5</a></li>
				</ul>
			</div>
		</nav>
