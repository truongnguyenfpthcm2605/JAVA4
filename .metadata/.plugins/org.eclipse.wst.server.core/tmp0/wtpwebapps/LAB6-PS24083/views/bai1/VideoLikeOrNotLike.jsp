...
<div class="container" style="margin: 10px auto;">
	...
	<hr>
	<form action="${app}/check/*" method="post"
		style="width: 60%; margin: 10px auto;">
		<div style="display: flex; justify-content: space-evenly;">
			<div class="form-check-inline">
				<label class="form-check-label"> <input type="radio"
					${isChecked?'checked="checked"':''} onClick="this.form.submit()"
					class="form-check-input" name="isFavorite" value="true">
					Favorited
				</label>
			</div>
			<div class="form-check-inline">
				<label class="form-check-label"> <input type="radio"
					${isChecked?'':'checked="checked"'} onClick="this.form.submit()"
					class="form-check-input" name="isFavorite" value="false">
					Not Favorited
				</label>
			</div>
