...
<div class="onhead">
			...
			<div class="container d-flex flex-wrap"
				...
				<a href="/ASM-PS24083/views/jsp/index.jsp"
					...
					<svg class="bi me-2" width="40" height="32">
                        ...
                        </svg> <span class=" titlewep">Bai 3 &#169;</span>
				</a>
				<div
	...
	<div class="rows bg-light">
		<nav class="navbar navbar-expand-lg navbar-light bg-light"
			...
			<a class="navbar-brand" href="${app}/findByKeyword"><span><i
					class='bx bxs-home'></i></span>FindByKeyWord</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto navs">
					...
					<li class="nav-item"><a class="nav-link"
						href="${app}/findByUser" style="color: green; cursor: pointer;"
						class='bx bxs-heart'><i class='bx bxs-book-content'></i> FindByUser</a></li>
					<li class="nav-item"><a class="nav-link" href="${app}/findInRange"
						style="color: green; cursor: pointer;" class='bx bxs-heart'><i
							class='bx bxs-book-content'></i>FindInRange</a></li>
					<li class="nav-item"><a class="nav-link" href="${app}/findInMotnhs"
						style="color: green; cursor: pointer;" class='bx bxs-heart'><i
							class='bx bxs-book-content'></i>FindInMotnhs</a></li>
