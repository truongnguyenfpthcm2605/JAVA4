...
<c:url var="app" value="/account"/>
			...
			<div class="container d-flex flex-wrap"
				...
				<a href="/ASM-PS24083/views/jsp/index.jsp"
					...
					<svg class="bi me-2" width="40" height="32">
                        ...
                        </svg> <span class=" titlewep">User Manager
					&#169;</span>
				</a>
				<div
	...
	<div class="rows bg-light">
		<nav class="navbar navbar-expand-lg navbar-light bg-light"
			...
			<a class="navbar-brand" href="${app}/sgin-up"><span><i
					class='bx bxs-home'></i></span> Đăng Ký</a>
				...
				<ul class="navbar-nav mr-auto navs">
					...
					<li class="nav-item"><a class="nav-link"
						...
						style="color: green; cursor: pointer;" class='bx bxs-heart'><i
							class='bx bxs-book-content'></i>Edit Profile</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${app}/sgin-in"
						style="color: green; cursor: pointer;" class='bx bxs-heart'><i
							class='bx bxs-book-content'></i>Đăng Nhập</a></li>
