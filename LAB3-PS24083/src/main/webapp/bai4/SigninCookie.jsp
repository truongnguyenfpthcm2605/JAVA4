...
<body>
		<form action="Cookie" method="post" style="width: 50%; margin: 0 auto;">
				<label class="badge bg-secondary">Tên</label> <input class="form-control" type="text" name="user" value="${user }" > <br>
				<label class="badge bg-secondary">Mật Khẩu</label> <input class="form-control" type="pass" name="pass" value="${pass }"> <br>
